<x-layout :title="$subject->name">
    ...
    <form action="{{ route('subject.update', $subject) }}" method="POST" class="flex flex-col gap-4"
        ...
        <textarea name="description" id="description" cols="30" rows="8" placeholder="@lang('subject.placeholder.description')" class="rounded-xl" x-model="fields.description"></textarea>
